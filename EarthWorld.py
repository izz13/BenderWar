...
for i in range(20):
    hitObjects["turrets"].append(turret.Turret(randint(0,3200), randint(0,2560), randint(1,200), "earthTurret.png", "earth", b_size, pimage="EarthAttack.png"))
...
while isRunning==True:
    ...
    #print(bkrdpos)
    screen.fill([0, 0, 0])
    screen.blit(EarthWorldbkrnd, bkrdpos)
